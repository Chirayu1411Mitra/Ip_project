...
const EditProfile = ({ onCancel }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // For faculty, also send designation and department
          ...
          <div className="flex flex-col sm:flex-row items-center sm:items-start gap-4 sm:gap-6">
            <div className="relative shrink-0">
              {imagePreview ? (
                ...
                <div className="w-20 h-20 sm:w-24 sm:h-24 bg-purple-500 rounded-full flex items-center justify-center text-white text-2xl sm:text-3xl font-semibold tracking-wide">
              ...
              <button
                ...
                disabled={loading}
                className="absolute bottom-0 right-0 bg-purple-400 text-white p-1.5 rounded-full border-[3px] border-white hover:bg-purple-700 transition-colors shadow-sm disabled:opacity-50"
              >
            ...
            <div className="text-center sm:text-left w-full sm:w-auto">
              ...
              <div className="flex flex-col sm:flex-row gap-3 justify-center sm:justify-start">
                <button
                  ...
                  disabled={loading}
                  className="w-full sm:w-auto flex items-center justify-center gap-2 bg-purple-400 hover:bg-purple-600 text-white px-4 py-2.5 sm:py-2 rounded-lg text-sm font-medium transition-colors shadow-sm disabled:opacity-50"
                >
          ...
          <form className="space-y-5 sm:space-y-6" onSubmit={handleSubmit}>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    disabled={loading}
                    className="w-full pl-10 pr-4 py-2.5 rounded-xl border border-slate-200 focus:ring-2 focus:ring-purple-500 focus:border-purple-500 outline-none transition-all text-sm sm:text-base text-slate-700 bg-[#FAFAFA] disabled:opacity-50"
                  />
                </div>
              </div>
            ...
            <div>
              ...
              <textarea
                ...
                disabled={loading}
                maxLength="200"
                className="w-full px-4 py-3 rounded-xl border border-slate-200 focus:ring-2 focus:ring-purple-500 focus:border-purple-500 outline-none transition-all text-sm sm:text-base text-slate-700 bg-[#FAFAFA] resize-none disabled:opacity-50"
              ></textarea>
            ...
            <div className="flex flex-col-reverse sm:flex-row justify-end gap-3 pt-5 sm:pt-6 border-t border-slate-100 mt-2 sm:mt-4">
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full sm:w-auto px-5 py-2.5 sm:py-2 rounded-lg font-medium text-white bg-purple-500 hover:bg-purple-600 transition-colors shadow-sm disabled:opacity-50 text-sm sm:text-base flex justify-center items-center"
              >
