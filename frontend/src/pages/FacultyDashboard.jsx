...
const FacultyDashboard = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto px-6 py-8 space-y-8">
      ...
      <div
        className="rounded-[24px] p-10 text-white relative overflow-hidden shadow-sm"
      ...
      >
        <div className="relative z-10">
          ...
          <p className="text-purple-100 opacity-90">
            Ready to manage your classes and announcements today?
          </p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {[
          ...
          <div
            key={i}
            className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm flex flex-col items-start relative overflow-hidden"
          >
            <div className={`p-2 rounded-lg bg-gray-50 ${stat.color} mb-4`}>
              {stat.icon}
            </div>
                    ...
                    <div className="min-w-0">
                      ...
                      {ann.files && ann.files.length > 0 && (
                        <p className="text-xs text-purple-600 mt-1">
                          {ann.files.length} file(s) attached
                        </p>
                      )}
                    </div>
                    <button
          ...
          <div className="space-y-4">
            {recentDoubts.length > 0 ? (
              recentDoubts.map((doubt) => (
                <div
                  key={doubt._id}
                  className="group flex items-center justify-between p-4 hover:bg-gray-50 rounded-xl transition-colors border border-transparent hover:border-gray-100"
                >
